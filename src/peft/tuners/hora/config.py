...
class HoRAConfig(PeftConfig):
    ...
    Args:
        ...
        dist (`int`):
            Number of distributed submatrix.
    ...
    random_loc_seed: Optional[int] = field(
        default=42, metadata={"help": "Seed for the random location of the frequencies."}
    )
